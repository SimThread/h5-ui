<template>
    <div :class="['h5-doc-simulator', { 'h5-doc-simulator-fixed': isFixed }]">
        <div class="h5-doc-simulator__nav">
            <div class="h5-doc-simulator__url">{{ iframeHostName }}</div>
            <div
                class="h5-doc-simulator__reload"
                @click="reloadIframe"
            />
        </div>
        <iframe
