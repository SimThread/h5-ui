...
export default {
  ...
  'empty': () => wrapper(import('../../packages/empty/demo'), 'empty'),
  ...
  'lottie': () => wrapper(import('../../packages/lottie/demo'), 'lottie'),
  ...
  'svg-icon': () => wrapper(import('../../packages/svg-icon/demo'), 'svg-icon'),
