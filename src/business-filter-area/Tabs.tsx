...
const [name, bem] = createNamespace('business-filter-area');
  ...
  setup(props, { emit, slots }) {
    ...
    const init = () => {
      ...
      nextTick(() => {
        ...
        state.wrapTop = getVisibleTop(wrapRef.value!);
        scrollIntoView(true);
      });
    };
    ...
    const wrapStyle = computed(() => ({ top: `${state.wrapTop}px` }));
