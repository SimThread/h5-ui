<template>
    <demo-section>
        ...
        <demo-block title="横向滚动">
            <h5-scroll ref="scroll" :data="horizontalItems" direction="horizontal" class="horizontal-scroll-list-wrap">
...
export default {
    ...
    methods: {
        scrollTo() {
            this.$refs.scroll.scrollTo(0, this.scrollToY, this.scrollToTime, ease[this.scrollToEasing]);
        },
        updateScrollbar(val) {
            this.scrollbar = val;
        },
